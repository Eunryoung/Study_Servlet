...
<body>
	...
	POST 방식은 form 태그 내에 method="post"를 명시해야하며
	...
	<!-- form 태그를 사용하여 GET 방식과 POST 방식으로 각각 "myServlet" 서블릿 주소 요청 -->
	<form action="myServlet" method="get">
		<input type="submit" value="myServlet 서블릿 주소 요청(GET)">
	</form>
	
	<!-- 요청 방식에 대해 일치하는 메서드(doPost())가 없을 경우 HTTP 405 에러 발생! -->
	<form action="myServlet" method="post"> <!-- POST 방식 요청은 method="post" 필수 -->
